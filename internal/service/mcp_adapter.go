...
const suggestBlastSourcesTool = "suggest_blast_radius_sources"
...
var toolAnnotations = map[string]*mcp.ToolAnnotations{
	...
	"get_snapshot_topology":     annReadOnly,
	"list_l7_applications":      annReadOnly,
	"analyze_network_prefixes":  annReadOnly,
	"run_nqe_query":             annReadOnly,
	"run_nqe_query_by_id":       annReadOnly,
	"start_nqe_query":           annReadOnly,
	"get_nqe_query_status":      annReadOnly,
	"get_nqe_query_result":      annReadOnly,
	...
	"get_nqe_diff":              annReadOnly,
	"get_snapshot_diff_summary": annReadOnly,
	"get_snapshot_diff":         annReadOnly,
	"get_blast_radius":          annReadOnly,
	suggestBlastSourcesTool:     annReadOnly,
	"list_predefined_checks":    annReadOnly,
	"list_checks":               annReadOnly,
	"get_check":                 annReadOnly,
	"list_devices":              annReadOnly,
	"get_missing_devices":       annReadOnly,
	"get_device_locations":      annReadOnly,
	"list_classic_devices":      annReadOnly,
	"get_classic_device":        annReadOnly,
	"list_cli_credentials":      annReadOnly,
	"list_snmp_credentials":     annReadOnly,
	"get_performance_settings":  annReadOnly,
	"list_performance_devices":  annReadOnly,
	"get_device_performance":    annReadOnly,
	"get_interface_performance": annReadOnly,
	"get_collector_status":      annReadOnly,
	"get_collector_task":        annReadOnly,
	"list_collection_schedules": annReadOnly,
	"wait_for_latest_snapshot":  annReadOnly,
	...
	"create_cli_credential":  annCreate,
	"create_snmp_credential": annCreate,
	"start_collection":       annCreate,
	"start_collection_task":  annCreate,
	...
	"upsert_classic_devices":      annUpdate,
	"update_performance_settings": annUpdate,
	"cancel_collection":           annUpdate,
	...
	"delete_classic_devices": annDelete,
	"delete_cli_credential":  annDelete,
	"delete_snmp_credential": annDelete,
}
